...
Meteor.methods({
  addLeague: function(leagueAttributes) {
   ...
   // make sure the same league name has not already been entered 
    ...
    var league = _.extend(_.pick(leagueAttributes, 'leagueName', 'leagueAdminFirstName', 'leagueAdminLastName', 'leagueAdminEmail', 'leagueSummary'), {
  ...
  deleteLeague: function(leagueId) {
    ...
    if (!Roles.userIsInRole(loggedInUser, "league-admin")) {
